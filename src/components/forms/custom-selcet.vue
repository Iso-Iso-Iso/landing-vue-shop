...
div( class="block relative ")
    select( class="select block w-full p-1 text-base bg-gray-100 border-solid border-[1px] border-gray-300 pr-[30px]" :value="value" @click="isSelectOpen = !isSelectOpen" @select="$emit('input',$event.target.value)")
        slot 
