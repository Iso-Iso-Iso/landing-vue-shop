...
<template lang="pug">
label(class="border-dashed  cursor-pointer h-[125px] w-full  flex justify-center items-center flex-col bg-gray-100" :class="[isDragOver?'border-primary border-2':'border-gray-300  border-[1px]']" @dragover="onDragOver($event)" @dragleave="onDragLeave()" @drop="onDrop($event)" )
